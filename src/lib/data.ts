...
export const accounts: Account[] = [
  { id: 'acc_1', name: 'Starlight Properties', companyName: 'Starlight Properties', officeAddress: '123 Main St, Anytown USA', phone: '555-1234', website: 'starlight.com', stage: 'Active', industry: 'Commercial Real Estate', totalValue: 750000, contactIds: ['con_1', 'con_4'], propertyIds: ['prop_1', 'prop_4'], vendorManagementSoftware: 'RealPage', vendorOnboardingCompleted: 'Yes', insuranceRequirements: 'General Liability $2M', prospectingStage: 'Relationship Building' },
